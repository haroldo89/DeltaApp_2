...
// ===================================================================================================
// Versión	        Descripción
// 1.0.0.0	        Funciones generales para control autocomplete con item no seleccionado.
// ===================================================================================================
...
function AutoCompleteHelperNoSelected() { }
 ...
 *
 */
AutoCompleteHelperNoSelected.getAutocompleteDataSource = function (request, matcher, sourceListControlName) {
 ...
 *
 */
AutoCompleteHelperNoSelected.onControlBlur = function (ui, sourceSearchControlId, sourceListControlId) {
